...
(() => {
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      #${PANEL_ID}>.kyaa-panel-bg{position:absolute;z-index:0;inset:7px -13px 10px;border-radius:7px;background:#1d1210;pointer-events:none}
