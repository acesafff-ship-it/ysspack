...
(() => {
  ...
  function injectStyles() {
    ...
    style.id = STYLE_ID;
    style.textContent = `
      #${PANEL_ID}.c-window{display:block!important;visibility:visible!important;position:fixed!important;z-index:100!important;width:326px!important;height:298px!important;box-sizing:border-box;background:transparent!important;border-radius:12px!important;color:#fff;font:12.8px/16.64px Arimo,Calibri,"Segoe UI",Arial,sans-serif;filter:drop-shadow(0 3px 5px #000)}
      #${PANEL_ID} *{box-sizing:border-box}
      #${PANEL_ID}>.kyaa-panel-bg{position:absolute;z-index:0;inset:7px 7px 10px;border-radius:7px;background:#1d1210;pointer-events:none}
